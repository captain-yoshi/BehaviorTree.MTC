     ...
     <BehaviorTree ID="MainTree">
        <Sequence name="root">
            ...
            <CreateMTCConnect  stage_name="MoveToPick"
                               ...
                               planner="{rrt_connect}"
                               stage="{connect}" />
            <StageConfigureInitFromMTCProperties  stage="{connect}"
                                                  property_names=""
                                                  source_flag="PARENT" />
            ...
            <AllowCollisionsJointModelGroup stage_name="allow collisions -> hand,object"
                                            ...
                                            task="{mtc_task}" />
            <MoveMTCStageToContainer  container="{pick_object}"  stage="{allow_collisions_object_robot}" />
          ...
          <CreateMTCMoveRelativeTranslate  stage_name="lift object"
            ...
            <CreateMTCConnect  stage_name="Move To Place"
                                ...
                                planner="{rrt_connect}"
                                stage="{connectPlace}" />
            <StageConfigureInitFromMTCProperties  stage="{connectPlace}"
                                             property_names=""
                                             source_flag="PARENT" />
            ...
            <MoveMTCStageToContainer  container="{place_object}" stage="{stage_move_to_open_hand2}" />
            <ForbidCollisionsJointModelGroup  stage_name="forbid collisions -> hand,object"
                                              stage="{forbid_collisions_object_robot}"
                                              objects="{object_name}"
                                              jmg_name="{hand_group_name}"
                                              task="{mtc_task}" />
            <MoveMTCStageToContainer  container="{place_object}" stage="{forbid_collisions_object_robot}" />
            <CreateMTCModifyPlanningSceneDetachObjects  stage_name="detach object"
                                                        stage="{detach_object}"
                                                        object_names="{object_name}"
                                                        link_name="{hand_frame}" />
            <MoveMTCStageToContainer  container="{place_object}"  stage="{detach_object}" />
            ...
            <StageConfigureInitFromMTCProperties  stage="{retreat_after_place}"
                                             property_names="group"
                                             source_flag="PARENT" />
            <MoveMTCStageToContainer  container="{place_object}" stage="{retreat_after_place}" />
            ...
            <StageConfigureInitFromMTCProperties  stage="{stage_move_to_home}"
                                             property_names="group"
                                             source_flag="PARENT" />
             <MoveMTCStageToContainer  container="{task_container}" stage="{stage_move_to_home}" />
