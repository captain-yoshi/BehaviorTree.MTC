...
PipelinePlanner::PipelinePlanner(const std::string& name, const BT::NodeConfig& config)
  : SyncActionNode(name, config)
{}

BT::NodeStatus PipelinePlanner::tick()
{
  // Retrieve inputs
...
BT::PortsList PipelinePlanner::providedPorts()
{
  return {
    //Output
