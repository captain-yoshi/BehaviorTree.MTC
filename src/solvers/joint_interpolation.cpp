...
JointInterpolation::JointInterpolation(const std::string& name, const BT::NodeConfig& config)
  : SyncActionNode(name, config)
{}

BT::NodeStatus JointInterpolation::tick()
{
  // Retrieve inputs
...
BT::PortsList JointInterpolation::providedPorts()
{
  return {
